...
function journalSCI() {
  ...
  for (let i = 0; i < paperArray.length; i++) {
    const paperInfo = paperArray[i];
    paperList += `<a href="#" onclick="SCIOpenPaper(${i})" style="color: #1c2021; font-size : 0.9em; text-decoration: none; border: none;"> ${paperInfo}</a><br><br>`;
  }
...
function journalSCOPUS() {
  ...
  for (let i = 0; i < paperArray.length; i++) {
    const paperInfo = paperArray[i];
    paperList += `<a href="#" onclick="SCOPUSOpenPaper(${i})" style="color: #1c2021; font-size : 0.9em; text-decoration: none; border: none;">  ${paperInfo}</a><br><br>`;
